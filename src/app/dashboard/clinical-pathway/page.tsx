    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-light tracking-tight text-foreground">Validasi Klaim</h1>
      ...
      {jobs.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-xl border border-border bg-card p-16 text-center shadow-sm">
          ...
          <p className="text-sm text-muted-foreground font-light mt-1 mb-6 max-w-sm">Belum ada riwayat validasi klaim. Mulai dengan membuat validasi baru.</p>
          <Link href="/dashboard/clinical-pathway/baru" className="inline-flex items-center justify-center rounded-md border border-border bg-card px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-muted focus:outline-none">Mulai Validasi</Link>
        </div>
